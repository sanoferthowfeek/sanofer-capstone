  ...
  return (
    <div>
      ...
      <Cards  name="Yogurt Toast" 
         ...
         ingredient1='¼ cup chia seeds, ¼ cup granola'
         ingredient2='1 tablespoon pure maple syrup'
         ingredient3='¾ teaspoon vanilla extract'
         ingredient4=' ½ cup whole-milk plain Greek yogurt'
        ...
        <Cards  name="Coconut-Mango Oats" 
         type="Oats" 
         time="5 minutes" 
         ingredient='1 cup unsweetened oat milk'
         ingredient1='½ cup quick oats,salt'
         ...
         step3="Remove from heat and stir in 1 1/2 teaspoons coconut, brown sugar and vanilla"
         step4="Top with mango, the remaining 1 1/2 teaspoons coconut and chia seeds"
         img= 'https://media.istockphoto.com/id/1128328281/photo/pineapple-mango-smoothie-bowl-with-coconut-bananas-blueberries-and-granola-above-view-on-a.webp?b=1&s=170667a&w=0&k=20&c=9ZDjxfYtPUGNXtSghd-BJFDiLgaAxbxa3KABhW2noCs='/>

          <Cards  name="Chettinad Style Tomato Vermicelli Upma" 
         type="Upma" 
         time="25 minutes" 
         ingredient='1 cup Semiya, 1 Pearl onions(finely chopped)'
         ingredient1='Garlic, 1 inch Ginger'
         ingredient2='3 Tomatoes,1 teaspoon Mustard seeds'
         ingredient3=' 1/4 cup Mint Leaves,1 teaspoon Fennel seeds'
         ingredient4='Lemon juice,Oil,Salt,Cloves,Cinnamon stick'
         ingredient5=' Curry leaves,Red Chilli powder,Turmeric powder'
         step="Heat a pan with cooking oil on medium heat, add the mustard seeds, cinnamon stick, cloves, curry leaves and let it splutter"
         ...
         type="Oats" 
         time="20  minutes" 
         ingredient=' 3 cups low-fat milk'
         ingredient1=' ¾ teaspoon ground cinnamon, plus more for sprinkling'
         ingredient2='¼ teaspoon ground '
         ingredient3='ginger,salt,rolled oats'
         ingredient4='3 tablespoons pure maple syrup,vanilla extract'
         ingredient5=' 4 large ripe bananas, divided'
         step="Peel and slice 1 banana"
         step1="Using a fork, mash the remaining 3 bananas in a large saucepan"
         step2="Add milk and scraping the bottom of the pan often with a wooden spoon"
         step3="Stir in oats, maple syrup, vanilla, cinnamon, ginger and salt"
         step4="Cook, scraping the bottom of the pan often with the spoon, until the mixture is thick and creamy, about 5 minutes"
         img= 'https://media.istockphoto.com/id/1354239159/photo/healthy-oatmeal-smoothi-e-with-fruits-and-seeds.webp?b=1&s=170667a&w=0&k=20&c=2ZSE1wIhWbhLh2Gf2AzgDFnTwhYbyXDe_arknV5BZfA='/>
